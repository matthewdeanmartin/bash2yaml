"""Create consistently configured YAML parsers without shared mutable state."""

from ruamel.yaml import YAML


def get_yaml() -> YAML:
    """Create a fresh YAML parser configured for GitLab CI with !reference tag support."""
