"""Improved update checker utility for bash2yaml (standalone module).
...
from bash2yaml.utils.urllib3_helper import fetch_json
...
def fetch_pypi_json(url: str, timeout: float, logger: logging.Logger) -> dict:
    ...
    try:
        ...
        logger.debug(f"bash2yaml error fetching JSON: {e}")
