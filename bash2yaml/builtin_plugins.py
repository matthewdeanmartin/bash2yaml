...
from bash2yaml.utils.parse_bash import extract_script_path as _extract

hookimpl = HookimplMarker("bash2yaml")
logger = logging.getLogger(__name__)


class Defaults:
    """Default plugin implementations for bash2yaml hooks."""
