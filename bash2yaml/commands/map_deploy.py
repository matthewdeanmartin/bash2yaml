...
from bash2yaml.commands.compile_not_bash import _INTERPRETER_EXTS
from bash2yaml.commands.hash_path_helpers import find_hash_file, get_output_hash_path
