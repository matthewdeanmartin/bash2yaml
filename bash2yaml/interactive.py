"""
Rich-based interactive Q&A interface for bash2yaml.

This module provides an interactive command-line interface using Rich library
for a more user-friendly experience with bash2yaml commands.
"""
...
class InteractiveInterface:
    """Rich-based interactive interface for bash2yaml."""
    ...
    def show_welcome(self) -> None:
        ...
        welcome_text = Text()
        welcome_text.append("bash2yaml", style="bold blue")
    ...
    def show_main_menu(self) -> str:
        ...
        menu_options = [
            ...
            ("7", "init", "Initialize new bash2yaml project"),
    ...
    def run(self) -> None:
        ...
        while True:
            try:
                ...
                if choice == "q":
                    self.console.print("\n[bold blue]Thank you for using bash2yaml! 👋[/bold blue]")
                    break
